...
# creating rectangle limits for collision detection
...
while True:
    ...
    # re-renders an image after a keystroke move
    ...
    for event in pygame.event.get():
        if event.type == QUIT:
            pygame.quit()
            # it is a better alternative than breaking or changing the condiiton to False
            sys.exit()
